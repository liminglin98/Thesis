...
##
# Load the data
df = CSV.read(joinpath(DERIVED_DIR, "df_final.csv"), DataFrame);
##
...
savefig(joinpath(OUTPUT_DIR, "CMPI Comparison (MANR2026).png"))
## No Lag
...
savefig(joinpath(OUTPUT_DIR, "CMPI Comparison (No Lags).png"))
##
# IV-SVAR
using LinearAlgebra

# safe_cholesky and make_spd are loaded from common.jl
...
display(plot_svar)
savefig(plot_svar, joinpath(OUTPUT_DIR, "irf_svar.png"))
