...
The real effective exchange rate appreciates, consistent with standard theory: the REER rises to a peak of approximately 1.25pp around the tenth month before reverting toward zero. Industrial production, included both as a robustness check on the GDP response and as an input to the counterfactual, displays a qualitatively similar pattern — an initial spike to 0.5pp around the third month, a zero crossing at the fourth month, and a trough near $-$1pp around the thirteenth month. The IP response is roughly double the GDP response in magnitude, which likely reflects the higher cyclical sensitivity of industrial output relative to services-inclusive GDP in the Chinese economy.
