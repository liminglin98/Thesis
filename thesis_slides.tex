...
\begin{itemize}
      ...
      \end{itemize}
      \item One important caveat is that the reduced form forecast produces a very pessmisstic baseline path from 2023 onward. Having policy rate below the forecast boosts inflation and output. Same for the Industrial Value Added in the last column; although the it decreases anyway, the counterfactual paths are somewhat better than the forecast.
\end{itemize}
\end{frame}
