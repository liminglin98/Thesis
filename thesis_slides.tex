...
\textbf{Top.} Actual FR007 vs.\ predicted FR007 from the rule regression.
\textbf{Bottom.} Estimated residual series $\widehat{\varepsilon}^{\text{MP}}_t$,
used as the narrative monetary policy shock.
 
\vspace{0.5em}
\begin{center}
\includegraphics[width=0.9\textwidth,height=0.28\textheight,keepaspectratio]{outputs/robustness/2025/FR007_fit_comparison.png}\\[0.35em]
\includegraphics[width=0.9\textwidth,height=0.28\textheight,keepaspectratio]{outputs/robustness/2025/FR007_residuals_comparison.png}
\end{center}

\vspace{0.3em}
\textcolor{spgray}{\scriptsize Robustness: regression re-estimated excluding
2020 to verify that COVID-period observations do not unduly drive the
...
\vspace{0.5em}
\begin{center}
\includegraphics[width=0.9\textwidth,height=0.4\textheight,keepaspectratio]{outputs/diagnostics/gdp_quarterly_vs_proxy_monthly.png}
\end{center}

\vspace{0.25em}
\textcolor{spgray}{\scriptsize Suggested content: quarterly reported GDP growth points overlaid with the implied proxy monthly GDP path that aggregates back to official quarterly totals.}
...
\textbf{Comparison goal.} Visual check of BVAR forecasted monthly GDP against realized proxy monthly GDP in the counterfactual window.

\vspace{0.5em}
\begin{center}
\includegraphics[width=0.9\textwidth,height=0.43\textheight,keepaspectratio]{outputs/diagnostics/2022/bvar_gdp_forecast.png}
\end{center}

\vspace{0.3em}
\textcolor{spgray}{\scriptsize Placeholder: forecast path from the baseline projection and realized proxy monthly GDP path over the same months, with optional shaded forecast horizon.}
